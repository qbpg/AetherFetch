      ...
      <div className={`w-full max-w-lg transition-all duration-300 ${exiting ? "opacity-0 scale-[0.97] translate-y-1" : "opacity-100 scale-100 translate-y-0"}`}>
        ...
        <div className="space-y-3">
          <button
            ...
            className="group w-full text-left p-4 bg-zinc-900 border border-zinc-800 rounded-xl transition-all duration-200 hover:border-zinc-700 hover:bg-zinc-900/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-600 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 disabled:opacity-60"
          >
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded-lg bg-zinc-800 border border-zinc-700/50 flex items-center justify-center flex-shrink-0 group-hover:border-zinc-600 transition-colors duration-200">
                  <Mail className="w-4 h-4 text-zinc-400 group-hover:text-zinc-200 transition-colors duration-200" />
                </div>
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-zinc-400 mt-0.5">Continue where you left off</p>
                </div>
              </div>
              <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-zinc-800/50 border border-zinc-800 flex items-center justify-center group-hover:bg-zinc-800 group-hover:border-zinc-700 transition-all duration-200">
                <ArrowRight className="w-3.5 h-3.5 text-zinc-500 group-hover:text-zinc-200 transition-colors duration-200" />
              </div>
            </div>
          </button>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="bg-zinc-950 px-2 text-[10px] text-zinc-500 uppercase tracking-widest">or</span>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded-lg bg-zinc-800 border border-zinc-700/50 flex items-center justify-center flex-shrink-0 group-hover:border-zinc-600 transition-colors duration-200">
                  <Plus className="w-4 h-4 text-zinc-400 group-hover:text-zinc-200 transition-colors duration-200" />
                </div>
                <div className="min-w-0">
                  <span className="text-sm font-medium text-zinc-100">New account</span>
                  <p className="text-[11px] text-zinc-400 mt-0.5">Generate a fresh temporary address</p>
                </div>
              </div>
              <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-zinc-800/50 border border-zinc-800 flex items-center justify-center group-hover:bg-zinc-800 group-hover:border-zinc-700 transition-all duration-200">
                <Plus className="w-3.5 h-3.5 text-zinc-500 group-hover:text-zinc-200 transition-colors duration-200" />
              </div>
            </div>
          </button>
        </div>
